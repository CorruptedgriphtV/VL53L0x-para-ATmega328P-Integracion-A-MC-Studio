...
#define RANGE_SEQUENCE_STEP_MSRC 0x0) /* Minimum Signal Rate Check */
...
static bool device_is_booted()
{
    ...
    return device_id == VL53L0X_EXPECTED_DEVICE_ID;//-----------se espera que se reciba 0xee=238
}
...
{
    gpio_set_output(vl53l0x_infos[idx].xshut_gpio, !enable);// pone en algo a XSHUT
}
